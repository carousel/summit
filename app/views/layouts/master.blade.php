...
<head>
    ...
    <title>PAK Summit Admin Panel</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user">&nbsp;</i>{{$username->username}}<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                       ...
                       <!-- <li>
                        ...
                        -->
                        <li>
                            <a href="/logout"><i class="fa fa-fw fa-power-off"></i> Odjava</a>
                        </li>
                    </ul>
                </li>
            </ul>
