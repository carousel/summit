            ...
            <div class="container-fluid">
                ...
                PAK Summit <small>lista članova (klikni za prikaz i izmjenu)</small>
                    ...
                    <div class="pull-right">
                        {{Form::open(["url"=>"/old-members-search","method"=>"POST","class"=>"form-inline"])}}
                            {{Form::label("pojam")}}
                            {{Form::text("search","",["class"=>"form-inline","placeholder"=>"pojam za pretragu"])}}
                            {{Form::label("filter")}}
                            {{Form::select("filter",["ime","prezime","email"],["ime","prezime","email"],["class"=>"form-inline"])}}
